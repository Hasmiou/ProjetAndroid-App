...
import fr.uge.projetandroid.adapters.AdapterSlideAcceuilAchat;
import fr.uge.projetandroid.entities.User;
import fr.uge.projetandroid.handlers.HttpHandler;

public class AcceuilAchat extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    private ViewPager viewpager_home_achat;
    private LinearLayout LinearLayout_home_dots_achat;
    private AdapterSlideAcceuilAchat adapterSlideAcceuilAchat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterSlideAcceuilAchat =new AdapterSlideAcceuilAchat(this,user,devise,rate);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                new AcceuilAchat.ChangeCurrencyTask().execute();
        ...
        mSearchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                if(query!=null){
                    Intent myIntent = new Intent(AcceuilAchat.this, AfficherProduitsRechercheAchat.class);
