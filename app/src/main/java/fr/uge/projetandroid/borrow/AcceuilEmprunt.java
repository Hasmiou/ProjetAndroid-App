...
import fr.uge.projetandroid.adapters.AdapterSlideAcceuilEmprunt;
import fr.uge.projetandroid.entities.User;

public class AcceuilEmprunt extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    private ViewPager viewpager_home_emprunt;
    private LinearLayout LinearLayout_home_dots_emprunt;
    private AdapterSlideAcceuilEmprunt adapterSlideAcceuilEmprunt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acceuil_emprunt);
        ...
        adapterSlideAcceuilEmprunt =new AdapterSlideAcceuilEmprunt(this,user);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mSearchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                if(query!=null){
                    Intent myIntent = new Intent(AcceuilEmprunt.this, AfficherProduitsRechercheEmprunt.class);
